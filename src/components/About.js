                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                        <div>
                            ...
                            <hr></hr>
                            <p className='slide-in-bottom'>Currently, Pursing my BTech Degree in PES University<br></br>
                            ...
                            <p className='slide-in-bottom'>
                                Previously worked as Game developer.<br></br>
                                The technology I've worked on : <span className="text-red ls-2">Unity Engine, <br></br>
                                C++, C, Rust. </span>
                            </p>
                            <p className='slide-in-bottom'>
                                Currently Learning React Js Library, Flutter and Dart
                            </p>
                        </div>
                    </div>
